  ...
  return (
    <div className="flex h-[50rem] bg-black text-white/80 relative">
      ...
      <div className="flex flex-1 flex-col gap-y-6 justify-center z-10 items-start absolute bottom-[50%] right-[22rem] max-lg:right-[6rem] max-md:static max-md:items-center max-md:text-center">
        <div className="relative w-fit h-fit text-black">
        ...
        <Link href={'/classes'}>
          <div className="group/button flex relative font-bold items-center bg-white text-black px-7 py-3">
            OUR CLASSES
            <IoArrowForward color={'red'} size={20} />
            <div className="absolute border-white border-[1px] w-full h-full left-[20%] -top-[30%] group-hover/button:left-0 group-hover/button:top-0 transition-all duration-500" />
          </div>
        </Link>
      </div>
    </div>
